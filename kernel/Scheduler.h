...
class Scheduler
{
  ...
  private:
    ...
    Queue<Process *, MAX_PROCS> m_queue_max;
    Queue<Process *, MAX_PROCS> m_queue_higher;
    Queue<Process *, MAX_PROCS> m_queue_default;
    Queue<Process *, MAX_PROCS> m_queue_lower;
    Queue<Process *, MAX_PROCS> m_queue_min;
};
